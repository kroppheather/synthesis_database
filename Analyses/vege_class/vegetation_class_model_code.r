...
##########################################################
##########################################################
### This model code uses vegetation classes            ###
### updated by coauthors to look at patterns in soil   ###
###  and air temp parms using                          ###
### the simpliest measure of dominant vegetation type  ###
##########################################################
...
#likelihood
	...
	#get regression uncertainties for regression lines
	for(i in 1:Ndepth){
		for(j in 1:Nvege ){
