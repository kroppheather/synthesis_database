...
for(i in 1:5){
	...
	write.table(Mod.out$statistics, 
			paste0("c:\\Users\\hkropp\\Google Drive\\raw_data\\analysis_u7\\mod10_out\\model\\vege\\biome\\mod1\\",data.name[i],"Temp_mod_stats.csv"),
			sep=",",row.names=TRUE)
	write.table(Mod.out$quantiles, paste0("c:\\Users\\hkropp\\Google Drive\\raw_data\\analysis_u7\\mod10_out\\model\\vege\\biome\\mod1\\",data.name[i],"Temp_mod_quant.csv"),
			sep=",",row.names=TRUE)
...
dir.create(paste0("c:\\Users\\hkropp\\Google Drive\\raw_data\\analysis_u7\\mod10_out\\model\\vege\\biome\\mod1\\",data.name[i]))	

mcmcplot(codaobj.init, parms=c("b1","b2","b3","b4","b5","sigV"),
			dir=paste0("c:\\Users\\hkropp\\Google Drive\\raw_data\\analysis_u7\\mod10_out\\model\\vege\\biome\\mod1\\",data.name[i]))		
