...
write.table(Airrepsubout,"/local/synthesis/output_u7m12r4/AirrepIDS.csv",sep=",",row.names=FALSE)
write.table(Soilrepsubout,"/local/synthesis/output_u7m12r4/SoilrepIDS.csv",sep=",",row.names=FALSE)
...
#model
write.table(Airtowriteout,"/local/synthesis/output_u7m12r4/Tair_model.csv",sep=",",row.names=FALSE)
write.table(Soiltowriteout,"/local/synthesis/output_u7m12r4/Tsoil_model.csv",sep=",",row.names=FALSE)
...
write.table(AirIDS2,"/local/synthesis/output_u7m12r4/AirIDS.csv", sep=",", row.names=FALSE)
write.table(SoilIDS2,"/local/synthesis/output_u7m12r4/SoilIDS.csv", sep=",", row.names=FALSE)

write.table(ALLSyearID,"/local/synthesis/output_u7m12r4/SoilTaveIDS_SD.csv", sep=",", row.names=FALSE)
write.table(ALLAyearID,"/local/synthesis/output_u7m12r4/AirTaveIDS_SD.csv", sep=",", row.names=FALSE)


write.table(IDnCombo,"/local/synthesis/output_u7m12r4/ncomboIDS.csv", sep=",", row.names=FALSE)
...
temp.modI<-jags.model(file="/home/hkropp/github/synthesis_database/Temp_model/temperature_mod_code_r6.r",
						data=datalist,
						n.adapt=7000,
						n.chains=3)
...
dir.create(paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i]))

write.table(Mod.out$statistics, paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i],"Temp_mod_stats.csv"),
			sep=",",row.names=TRUE)
write.table(Mod.out$quantiles, paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i],"Temp_mod_quant.csv"),
			sep=",",row.names=TRUE)
...
write.table(chain1,paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i],"chain1_coda.csv"), sep=",")
chain2<-as.matrix(codaobj.init[[2]])
write.table(chain2,paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i],"chain2_coda.csv"), sep=",")
chain3<-as.matrix(codaobj.init[[3]])
write.table(chain3,paste0("/local/synthesis/output_u7m12r4/site",sitesS$siteid[i],"chain3_coda.csv"), sep=",")
