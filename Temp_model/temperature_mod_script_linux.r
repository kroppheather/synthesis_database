...
write.table(Airrepsubout,"/local/synthesis/output_u7m10r3/AirrepIDS.csv",sep=",",row.names=FALSE)
write.table(Soilrepsubout,"/local/synthesis/output_u7m10r3/SoilrepIDS.csv",sep=",",row.names=FALSE)
...
#model
write.table(Airtowriteout,"/local/synthesis/output_u7m10r3/Tair_model.csv",sep=",",row.names=FALSE)
write.table(Soiltowriteout,"/local/synthesis/output_u7m10r3/Tsoil_model.csv",sep=",",row.names=FALSE)
...
write.table(AirIDS2,"/local/synthesis/output_u7m10r3/AirIDS.csv", sep=",", row.names=FALSE)
write.table(SoilIDS2,"/local/synthesis/output_u7m10r3/SoilIDS.csv", sep=",", row.names=FALSE)

write.table(ALLSyearID,"/local/synthesis/output_u7m10r3/SoilTaveIDS_SD.csv", sep=",", row.names=FALSE)
write.table(ALLAyearID,"/local/synthesis/output_u7m10r3/AirTaveIDS_SD.csv", sep=",", row.names=FALSE)


write.table(IDnCombo,"/local/synthesis/output_u7m10r3/ncomboIDS.csv", sep=",", row.names=FALSE)
...
dir.create(paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i]))

write.table(Mod.out$statistics, paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i],"Temp_mod_stats.csv"),
			sep=",",row.names=TRUE)
write.table(Mod.out$quantiles, paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i],"Temp_mod_quant.csv"),
			sep=",",row.names=TRUE)
...
write.table(chain1,paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i],"chain1_coda.csv"), sep=",")
chain2<-as.matrix(codaobj.init[[2]])
write.table(chain2,paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i],"chain2_coda.csv"), sep=",")
chain3<-as.matrix(codaobj.init[[3]])
write.table(chain3,paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i],"chain3_coda.csv"), sep=",")
...
mcmcplot(codaobj.init, parms=c("T.aveA1","TminA","TmaxA","T.aveS1",
			...
			dir=paste0("/local/synthesis/output_u7m10r3/site",sitesS$siteid[i]))		
